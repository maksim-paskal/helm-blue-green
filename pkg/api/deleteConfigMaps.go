...
func deleteConfigMaps(ctx context.Context, config *config.Type, labelSelector string) error {
	const deleteTypeName = "ConfigMaps"

	deleteType := kube().CoreV1().ConfigMaps(config.Namespace)
